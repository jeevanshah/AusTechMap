...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Newcastle upon Tyne, England, gb", False),
        ("Sydney, Nova Scotia, Canada", False),
        ("Perth, Scotland, United Kingdom", False),
        ("Melbourne, FL, USA", False),
        ("Atlanta, GA, us", False),
        ("Auckland, Auckland, nz", False),
        ("Pune, MH, in", False),
        ("Australia (Remote); London, England, United Kingdom (Remote)", True),
        ("", False),
        (None, False),
    ],
)
