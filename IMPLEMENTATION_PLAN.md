...
- [x] Derive employer role demand and hiring momentum only when sufficiency thresholds pass (`hiring/signals.py`, `derive-hiring-signals` CLI). Strictly enforces the sufficiency rule: requires `sample_size >= 3` across distinct observation dates `>= 14` days apart. Insufficient historical span or sample size leaves `sufficient = false` and `momentum = null` (no manufactured velocity). Ran against live Neon database on 9 September 2026, successfully deriving 54 employer role signals and 107 skill signals across 25 active employers.
- [ ] Onboard and monitor at least 300 employer sources — **26 real verified sources now registered** (up from 12) across Lever, Ashby, and Greenhouse, all independently verified against real live APIs and registered in `hiring/fixtures/ats_source_seed_20260905.csv` and `company_ats_sources`. On 9 September 2026, `crawl-jobs --all` was executed against production, expanding live tech job coverage from 92 jobs to **1,139 live job postings across 25 active employers** (Airwallex 582, Zip Co 126, Eucalyptus 105, Megaport 47, Fleet Space 47, SiteMinder 38, Neara 37, Culture Amp 34, Catapult Sports 30, Zeller 20, Sitemate 15, Deputy 10, Morse Micro 10, Objective 8, Immutable 7, Prospa 6, Dovetail 5, Dremio 5, Octopus Deploy 4, Envato 3, Up/Ferocia 3, Hysata 2, Kasada 2, Lumary 1, Vow 1; Easy Agile active at 0). Every posting is content-addressed, taxonomy-classified, and skill-extracted.
