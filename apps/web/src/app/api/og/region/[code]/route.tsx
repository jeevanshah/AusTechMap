  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          Regional technology employer concentration, location-confirmed role
          demand, and migration policy context.
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          >
            <span
              style={{ fontSize: "36px", fontWeight: 900, color: "#a78bfa" }}
            >
              {activeJobsCount}
            </span>
            <span style={{ fontSize: "15px", color: "#94a3b8" }}>
      ...
      >
        <span>
          Methodology v1.0 • ABS ASGS 2021 & Sourced Migration Evidence
        </span>
