    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Sourced tech career footprint, active hiring signals, and verified migration evidence across Australia.
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px", marginTop: "10px" }}>
              <span style={{ fontSize: "17px", fontWeight: 700, color: hasSponsorship ? "#34d399" : "#cbd5e1" }}>
                {hasSponsorship ? "✓ " : ""}{sponsorshipText}
              </span>
            </div>
          </div>
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px", marginTop: "10px" }}>
              <span style={{ fontSize: "17px", fontWeight: 700, color: isRegional ? "#f59e0b" : "#94a3b8" }}>
