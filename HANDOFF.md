...
- **Live post-cleanup state:** 908 companies; 514 companies with an accepted location; **310 ambiguous links/companies**; 78 total audited superseded-link cleanups; six new superseded links from the approved deep-research import; nine pending review items.
- **Next safe work:** Clean up the six new superseded links with explicit approval, then resume normal product/ATS work. The remaining 304 ambiguous links have no active first-party evidence; do not infer locations. Five difficult review cases remain quarantined; see `docs/data-quality/ambiguous-location-review-resolution-20260910.csv`.
