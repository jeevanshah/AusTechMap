...
*User Scenario: "Software Engineer" + React + TypeScript + Hybrid + Sydney*
...
*User Scenario: Software Engineering + Sponsorship Evidence + Regional*
...
*User Scenario: Explore Newcastle & Lake Macquarie (`sa4: 111`)*
...
*User Scenario: Save Search + Watchlist + Change Event + Delivery + APP 11 Erasure*
