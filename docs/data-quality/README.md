...
`remaining-ambiguous-location-research-20260910.csv` and its candidate manifest record a complete bounded first-party recheck of those 312 remaining links. Two domains have complete official addresses matching the existing locality and are in `remaining-ambiguous-location-repair-preflight-20260910.csv`; it passes strict validation but has not been geocoded or imported. The remaining 310 records stay unresolved: 127 could not be reached, 178 had no street candidate, and five had only ambiguous or mismatched official office candidates. See the matching research report for the full breakdown.
