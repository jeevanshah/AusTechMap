...
- **Outcome:** Codex fast-forwarded the branch to `main` and pushed it. The change restores the tracked Prettier, Ruff, and strict-mypy checks; it includes no database migration or production data mutation.
